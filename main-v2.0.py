...
# TODO Move this into config later
statsList = ['k', 'd', 'a', 'wpm', 'cspm', 'goldspent', 'gspd', 'dmgshare', 'earnedgoldshare', 'goldat10', 'gdat10', 'goldat15', 'gdat15', 'xpat10', 'xpdat10', 'csat10', 'csdat10', 'csat15', 'csdat15']
...
class GUI(tk.Frame):
  ...
  def readData(self):
    _, extention = os.path.splitext(self.FILENAME)
    self.data = None
    ...
    if os.path.exists(pklFile):
      self.data = pd.read_pickle(pklFile)
    else:
